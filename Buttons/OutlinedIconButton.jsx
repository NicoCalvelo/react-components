...
export default function OutlinedIconButton({ className = "", type = "button", onClick, disable = false, tooltip, ...props }) {
  return (
    <div className="group relative">
      <button
        ...
        type={type}
        {...props}
        className={"icon-btn border hover:bg-primary-color hover:bg-opacity-10 " + className}
      >
        {props.children}
      </button>
      {tooltip && (
