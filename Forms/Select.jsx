  ...
  return (
    ...
    >
      <div className={className + " relative"}>
        ...
        {!loading && (
          <Listbox.Button as="div" className={buttonClassName + " flex items-center whitespace-nowrap w-full max-w-xs space-x-6 py-2 px-4 rounded-lg border"}>
            ...
            {(!selected || (isMulti && selected.length === 0)) && <p className="text-text-light flex-grow truncate font-light">{placeholder}</p>}
